...
step_size=2:40; %For user to adjust must be between 1-100
%Initialise storage
...
MOTP_p        = MOTP_store;
MOTA_p        = MOTA_store;
miss_ratio_p  = miss_ratio_store;
fp_ratio_p    = fp_ratio_store;
IDsw_ratio_p  = IDsw_ratio_store;
IDsw_p        = Accum_ID_SW_store;
step_size_p   = step_size;

save('hungarian_parts_result.mat','step_size_p','RunTime_p','MOTP_p','MOTA_p','miss_ratio_p','fp_ratio_p','IDsw_ratio_p','IDsw_p');
